...
export default function Volunteering() {
  return (
    <div className=' bg-primary'>
       <h1 id="volunteer" className="text-center py-3 text-5xl font-bold text-secondary">
        Volunteerig
      </h1>
      <div className='flex flex-wrap justify-around text-secondary sm:flex-col md:items-center'>
      <div className="my-12 w-96 h-96 p-12 rounded-full bg-primary bg-opacity-50 text-center md:rounded-xl md:w-80 md:p-5">
        ...
        <p className=' text-lg px-4'>Enter the data of the new students and add them to attend their trainings.</p>
      </div>
      ...
      <div className="my-12 w-96 h-96 p-12 rounded-full bg-primary bg-opacity-50 text-center md:rounded-xl md:w-80 md:p-5">
        ...
        <p className=' text-lg px-4'>Helping in management and organizing the kids within “ Al-Musaqaf Al-Saghir” competition. </p>
      </div>
      ...
      <div className="my-12 w-96 h-96 p-12 rounded-full bg-primary bg-opacity-50 text-center md:rounded-xl md:w-80 md:p-5">
        ...
        <p className=' text-lg px-4'>Taking the attendence during the session and chacking on the workshop.</p>
      </div>
      ...
      <div className="my-12 w-96 h-96 p-12 rounded-full bg-primary bg-opacity-50 text-center md:rounded-xl md:w-80 md:p-5">
        ...
        <p className=' text-lg px-4'>Doing research about diffrent topics in copmuter science and web development.</p>
      </div>
      </div>
    </div>
  )
